function GetBooks() {
  var url = 'http://localhost/har10/api/get_books.php';
...
function GetBooks_by_id() {
  ...
  var url ='http://localhost/har10/api/get_books_by_id.php?id=';
  url += id;
  var xhttp = new XMLHttpRequest();
  xhttp.open('GET', url, true);
  var jsonData = '';
...
function AddBook() {
	var url = 'http://localhost/har10/api/add_book.php';
	var xhttp = new XMLHttpRequest();
...
function DeleteBook() {
  ...
  var url ='http://localhost/har10/api/delete_books.php?id=';
  url += id;
  var xhttp = new XMLHttpRequest();
  ...
  function UpdateBook() {
    var url = 'http://localhost/har10/api/update_book.php';
    var xhttp = new XMLHttpRequest();
    xhttp.open('POST', url, true);
